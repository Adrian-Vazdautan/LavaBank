    ...
    <Box>
      <header className={classes.header}>
        <Group justify="space-between" h="100%">
          <Group gap="xs"> 
            <img src={lavaLogo} alt="LavaBank" style={{ height: '30px' }} />
            <Text fw={900} size="xl" variant="gradient" gradient={{ from: 'orange', to: 'red' }}>
              LavaBank
            </Text>
          </Group>
            ...
            <HoverCard width={600} position="bottom" radius="md" shadow="md" withinPortal>
              <HoverCard.Target>
                <a href="#" className={classes.link}>
                  <Center inline>
                    <Box component="span" mr={5} fw={700}>
                      PERSONAL
                    </Box>
